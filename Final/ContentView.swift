        ...
        ZStack {
            ...
            NavigationView {
                ZStack {
                    ...
                    HStack {
                        Image("Presents 1").resizable().frame(width: 100, height: 100)
                        Image("Presents 2").resizable().frame(width: 100, height: 100)
                        Image("Presents 3").resizable().frame(width: 100, height: 100)
                    }
                    //All the decorations
                    ZStack {
